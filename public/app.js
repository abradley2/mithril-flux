...
var TodoController = (function () {
    function TodoController(args) {
        this.todos = TodoStore_1.default.getAll();
        this.state = {
            newTodo: m.prop({
                title: '',
                completed: false
    ...
    TodoController.prototype.removeTodo = function (id) {
        var payload = {
    ...
    TodoController.prototype.editTodoTitle = function (id, title) {
        var payload = {
    ...
    TodoController.prototype.toggleTodoComplete = function (todo) {
        var payload = {
...
var TodoList = (function () {
    ...
    TodoList.prototype.controller = function (args) {
        return new TodoController(args);
    };
    TodoList.prototype.view = function (ctrl) {
        var todos = ctrl.todos, state = ctrl.state;
        return m('div', [
            m('div', [
                m('input[type="text"]', {
...
},{"../dispatcher":5,"../stores/TodoStore":6,"mithril":1}],5:[function(require,module,exports){
"use strict";
var Dispatcher = (function () {
    ...
    Dispatcher.prototype._invokeCallback = function (dispatchToken, payload) {
        this._isPending[dispatchToken] = true;
        this.callbacks[dispatchToken](payload);
        this._isHandled[dispatchToken] = true;
    };
    Dispatcher.prototype._onStartDispatching = function (payload) {
    ...
    Dispatcher.prototype._onEndDispatching = function () {
        this._activePayload = null;
        this._isDispatching = false;
    };
    Dispatcher.prototype.dispatch = function (payload) {
        ...
        this.callbacks.forEach(function (cb, dispatchToken) {
            if (!_this._isPending[dispatchToken]) {
                _this._invokeCallback(dispatchToken, _this._activePayload);
            }
        });
        this._onEndDispatching();
    };
    Dispatcher.prototype.waitFor = function (tokens) {
        var token;
        for (token in tokens) {
...
var TodoStore = (function () {
    function TodoStore(dispatcher) {
        ...
        this.dispatchToken = dispatcher.register(function (payload) {
            switch (payload.action) {
                default:
                    if (_this[payload.action])
                        _this[payload.action](payload);
                    break;
            }
        });
    }
    ...
    TodoStore.prototype['Todos.CREATE_TODO'] = function (payload) {
        var newTodo = _.clone(payload.todo);
        newTodo.id = Date.now();
        this._todos().push(newTodo);
    };
    TodoStore.prototype['Todos.TOGGLE_COMPLETED'] = function (payload) {
        var _this = this;
    ...
    TodoStore.prototype['Todos.EDIT_TITLE'] = function (payload) {
        var _this = this;
        this._todos().some(function (todo, idx) {
            if (todo.id === payload.id) {
    ...
    TodoStore.prototype['Todos.DELETE_TODO'] = function (payload) {
        this._todos(this._todos().filter(function (todo) {
            return todo.id !== payload.id;
        }));
    };
    TodoStore.prototype['Todos.REMOVE_COMPLETED'] = function (payload) {
        this._todos(this._todos().filter(function (todo) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.default = new TodoStore(dispatcher_1.default);

},{"../dispatcher":5,"mithril":1,"underscore":2}]},{},[3]);
